...
class DataIngestionConfig:
    ...
    downloaded_data_filepath: Path = os.path.join(
        root_dir, "downloaded_data", "data.zip"
    )
...
class PrepareBaseModelConfig:
    ...
    updated_base_model_filepath = os.path.join(
        root_dir, "updated_basemodel", "updatedbasemodel.h5"
    )
...
class ModeltrainerConfig:
    ...
    trained_model_filepath: Path = os.path.join(
        root_dir, "trained_model", "trainedmodel.h5"
    )
    updated_basemodel_filepath: Path = (
        PrepareBaseModelConfig.updated_base_model_filepath
    )
...
class ModelEvaluationConfig:
    root_dir: Path = os.path.join(TrainingPipelineConfig.root_dir, "model_evaluation")
