...
class ModelTrainer:
    ...
    def train_valid_generator(self):
        try:
            ...
            dataflow_kwargs=dict(target_size=self.model_trainer_config.params_image_size[:-1],
    ...
    def start_training(self):
        try:
            ...
            self.validation_steps = self.train_generator.samples//self.valid_generator.batch_size
            ...
            os.makedirs(os.path.dirname(self.model_trainer_config.trained_model_filepath),exist_ok=True)
            self.save_model(path=self.model_trainer_config.trained_model_filepath,model=self.prepared_model)
