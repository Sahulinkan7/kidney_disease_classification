...
class DataIngestionTrainingPipeline:
    ...
    def initiate_data_ingestion(self):
        try:
            ...
            logging.error(
                f"Inititating data ingestion stage in training pipeline interrupted due to {CustomException(e,sys)}"
            )
...
if __name__ == "__main__":
    try:
        ...
        logging.error(
            f"Data Ingestion stage interrupted due to {CustomException(e,sys)}"
        )
        raise CustomException(e, sys)
